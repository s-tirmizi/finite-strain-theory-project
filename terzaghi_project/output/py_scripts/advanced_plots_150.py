...
# ==========================================
ls_reader = pv.get_reader('output/bilayer_large_strain_load_-150.e')
ss_reader = pv.get_reader('output/small_strain_load_-150.e')
...
save_smart('output/plots/bilayer_strain_comparison_isochrones_-150')
plt.show()
...
save_smart('output/plots/bilayer_degree_of_consolidation_-150_2')
plt.show()